        ...
        if gm.is_connected:
            ...
            if HARDWARE:
                if booted:
                    ...
                    elif gm.button['LZ'] and gm.button['RZ'] and gm.button['LS2'] and gm.button['RS2']:
                        os.system("gnome-terminal -- '/home/khadas/BRUCE/BRUCE-OP/Play/poweroff.sh'")
            ...
            if time.time() - last_send_data_time >= send_data_dt:
                ...
                if thread_data['bear'][0] == 3 or thread_data['bear'][0] == 4:
                    thread_error = True

                if booted:
                    if thread_data['bear'][0] == 1 and leg_command['BEAR_enable'][0] == 0:
                        leg_command = MM.LEG_COMMAND.get()
