...
SENSE_STATE.add_block(name='imu_rot_matrix',   data=np.eye(3))
...
ESTIMATOR_STATE.add_block(name='right_foot_rot_matrix', data=np.eye(3))
...
ESTIMATOR_STATE.add_block(name='left_foot_rot_matrix', data=np.eye(3))
...
PLANNER_COMMAND.add_block(name='right_foot_rot_matrix', data=np.eye(3))
...
PLANNER_COMMAND.add_block(name='left_foot_rot_matrix',  data=np.eye(3))
